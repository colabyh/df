...
def main(input_dir, output_file):
    ...
    MODEL_INTERNET_PATH = \
        [
            "https://github.com/yihhan/3dcnn/raw/main/SRXT50_064_VM-0.2620.PTH",
            "https://github.com/yihhan/3dcnn/raw/main/SRXT50_094_VM-0.2504.PTH",
            "https://github.com/yihhan/3dcnn/raw/main/i3dcutmix_e11_l0.1612.model",
            "https://github.com/yihhan/3dcnn/raw/main/j3d_e1_l0.1374.model",
            "https://github.com/yihhan/3dcnn/raw/main/mc3_18_112_1cy_lilaug_nonorm_e9_l0.1905.model",
            "https://github.com/yihhan/3dcnn/raw/main/mc3_18_112t224_1cy_lilaug_nonorm_e7_l0.1901.model",
            "https://github.com/yihhan/3dcnn/raw/main/mc3cutmix_112_e15_l0.1970.model",
            "https://github.com/yihhan/3dcnn/raw/main/r2p1_18_8_112tr_112te_e12_l0.1741.model",
            "https://github.com/yihhan/3dcnn/raw/main/r2plus1dcutmix_112_e10_l0.1608.model",
            "https://github.com/yihhan/3dcnn/raw/main/res34_1cy_minaug_nonorm_e4_l0.1794.model"
        ]
    MODEL_FILE_PATH = \
        [
            "./models/SRXT50_064_VM-0.2620.PTH",
            "./models/SRXT50_094_VM-0.2504.PTH",
            "./models/i3dcutmix_e11_l0.1612.model",
            "./models/j3d_e1_l0.1374.model",
            "./models/mc3_18_112_1cy_lilaug_nonorm_e9_l0.1905.model",
            "./models/mc3_18_112t224_1cy_lilaug_nonorm_e7_l0.1901.model",
            "./models/mc3cutmix_112_e15_l0.1970.model",
            "./models/r2p1_18_8_112tr_112te_e12_l0.1741.model",
            "./models/r2plus1dcutmix_112_e10_l0.1608.model",
            "./models/res34_1cy_minaug_nonorm_e4_l0.1794.model"
        ]

    for i, j in enumerate(MODEL_INTERNET_PATH):
        r = requests.get(j)
        with open(MODEL_FILE_PATH[i], 'wb') as f:
            f.write(r.content)

    PRETRAINED_MODELS_3D = [{'type':'i3d',
                            'path':"./models/j3d_e1_l0.1374.model"},
                            {'type':'res34',
                            'path':"./models/res34_1cy_minaug_nonorm_e4_l0.1794.model"},
                            {'type':'mc3_112',
                            'path':"./models/mc3_18_112_1cy_lilaug_nonorm_e9_l0.1905.model"},
                            {'type':'mc3_224',
                            'path':"./models/mc3_18_112t224_1cy_lilaug_nonorm_e7_l0.1901.model"},
                            {'type':'r2p1_112',
                            'path':"./models/r2p1_18_8_112tr_112te_e12_l0.1741.model"},
                            {'type':'i3d',
                            'path':"./models/i3dcutmix_e11_l0.1612.model"},
                            {'type':'r2p1_112',
                            'path':"./models/r2plus1dcutmix_112_e10_l0.1608.model"}]

    # videopaths = sorted(glob(os.path.join(INPUT_DIR, "*.mp4")))
    # print(videopaths)
    # videopaths = [video for video in os.listdir(INPUT_DIR) if ".mp4" in video]
    # print(videopaths)

    videopaths = glob(os.path.join(INPUT_DIR, "*.mp4"))
    ...
    for i_video, videopath in enumerate(videopaths):
    ...
    for i_video, videopath in enumerate(videopaths_missing_faces):
    ...
    import sys ; sys.path.insert(0, './deepfake/deepfake/skp/')
    import yaml

    with open('./deepfake/deepfake/skp/configs/experiments/experiment001.yaml') as f:
    ...
    model2d.load_state_dict(torch.load('./models/SRXT50_094_VM-0.2504.PTH'))
    ...
    for videopath, faces in faces_by_videopath.items():
        try:
    ...
    for videopath, pred in predictions.items():
        ...
        test_videos.append(videopath)
        proba.append(preds_ensembled[videopath])
